...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_SYM] = LAYOUT_ansi_61(
        _______, _______,  _______, _______, _______, _______, _______, _______, _______, _______, _______,  _______,  _______,  _______,
        _______, _______,  _______, _______, _______, _______, KC_PIPE, KC_DLR,  KC_PERC, KC_CIRC, KC_TILD,  _______,  _______,  _______,
        _______, _______,  _______, _______, _______, _______, KC_UNDS, KC_EXLM, KC_AT,   KC_HASH, KC_GRV,   _______,            _______,
